...
`;GM_addStyle(R);const B=()=>{const t=n=>{const o=n.querySelector(".chat-author__display-name");let a=null;o&&(a=window.getComputedStyle(o).color),n.style.color!==a&&(n.style.color=a);const l=n.querySelector(".chat-line__username-container");l.style.borderColor!==a&&(l.style.borderColor=a)},e=n=>{n.forEach(o=>t(o))};let r=document.querySelectorAll(".chat-line__no-background");e(r);let i="";setInterval(()=>{const n=window.location.href;if(n!==i){i=n;let o=document.querySelector(".chat-scrollable-area__message-container");new MutationObserver(()=>{r=document.querySelectorAll(".chat-line__no-background"),e(r)}).observe(o,{childList:!0})}},500),addEventListener("click",()=>{const n=document.querySelector(".chat-input-tray__open");n&&setTimeout(()=>{const o=n.querySelectorAll(".chat-line__no-background");e(o)},400)})},G=D("div");window.addEventListener("load",()=>{const t=document.querySelector(".stream-chat-header");t&&h(t,G),B()})})();
